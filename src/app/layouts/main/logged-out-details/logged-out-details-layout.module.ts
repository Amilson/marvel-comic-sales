...
import { LoggedOutDetailsLayoutComponent } from './logged-out-details-layout.component';
...
@NgModule({
  declarations: [LoggedOutDetailsLayoutComponent],
  imports: [
  ...
  exports: [LoggedOutDetailsLayoutComponent],
})
export class LoggedOutDetailsLayoutModule {}
